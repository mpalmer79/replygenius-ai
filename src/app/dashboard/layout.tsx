...
const navigation = [
  ...
  { name: 'Reviews', href: '/dashboard/reviews', icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4">
          <div className="p-4 bg-gray-50 rounded-xl">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-gray-700">Reviews Used</span>
            ...
            <p className="mt-2 text-xs text-gray-500">Resets in 18 days</p>
          </div>
        </div>
      </aside>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="hidden sm:block text-left">
                    ...
                    <div className="text-xs text-gray-500">Acme Restaurant</div>
                  </div>
                  <svg 
                    className={`w-4 h-4 text-gray-400 hidden sm:block transition-transform ${profileMenuOpen ? 'rotate-180' : ''}`} 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
                ...
                {profileMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50">
                    <div className="px-4 py-3 border-b border-gray-100">
                      ...
                      <p className="text-xs text-gray-500 truncate">john@acmerestaurant.com</p>
                    </div>
                    ...
                    <div className="border-t border-gray-100 mt-1">
                      ...
                      >
                        {isLoggingOut ? (
                          <>
                            <svg className="animate-spin w-4 h-4 mr-3 text-red-600" fill="none" viewBox="0 0 24 24">
